...
namespace Shop_project.Forms
{
    public partial class ConfirmOrder : Form
    {
        ...
        private void buttonSendMail_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                MailAddress from = new MailAddress("horoshihblag@gmail.com","Менеджер \"GraffitiShop\"");
                MailAddress to = new MailAddress(textBoxEmail.Text);
                MailMessage mail = new MailMessage(from, to);
                mail.Subject = "Чек заказа \"GraffitiShop\"";
                mail.Body = body;
                mail.IsBodyHtml = true;
                SmtpClient smtp = new SmtpClient("smtp.gmail.com", 587);
                smtp.Credentials = new NetworkCredential("graffitishopviktor03@gmail.com", "sometfreez");
                smtp.EnableSsl = true;
                smtp.Send(mail);
